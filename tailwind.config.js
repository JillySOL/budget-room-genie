...
export default {
  darkMode: ["class"], // Assuming you might use dark mode based on index.css
  content: [
    "./index.html",
    "./src/**/*.{js,ts,jsx,tsx}",
  ],
  theme: {
    container: { // Added basic container settings
      center: true,
      padding: "2rem",
      screens: {
        "2xl": "1400px",
    ...
    extend: {
      colors: {
        ...
        // Existing budget colors remain
        'budget-accent': '#FF6B35',
        'budget-accent-dark': '#E85A2C',
        'budget-accent-light': '#FFE0D4',
        // Removed the hardcoded background: '#F8F9FA' as it's now handled by CSS variable
      },
      borderRadius: { // Added border radius mapping
        lg: "var(--radius)",
        md: "calc(var(--radius) - 2px)",
        sm: "calc(var(--radius) - 4px)",
      },
      keyframes: { // Added example keyframes if needed based on index.css
        "accordion-down": {
          from: { height: "0" },
